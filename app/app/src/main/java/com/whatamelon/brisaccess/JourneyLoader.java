...
public class JourneyLoader implements JSONRequest.NetworkListener
{
    ...
    public JourneyLoader(String fromId, String destId, String date, GoogleMap map, Activity activity)
    {
        this.fromId = fromId;
        this.destId = destId;
        this.date = date;
    ...
    public void networkRequestCompleted(String result)
    {
        ...
        {
            Toast.makeText(callerActivity, "Invalid destination.", Toast.LENGTH_SHORT).show();
